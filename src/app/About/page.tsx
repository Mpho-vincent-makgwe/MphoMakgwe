const AboutPage = () => {
    return (
      ...
      <h1 className="text-2xl font-bold text-blue-600 text-center mb-2">Hi there 👋</h1>

      <h2 className="text-xl font-semibold text-gray-800 text-center mb-4">Mpho Vincent Makgwe - Full Stack Software Engineering Student 👨‍💻</h2>
<div className="text-lg text-gray-700 mb-6">
      ...
      <p>
        - I am a passionate and driven individual with a strong foundation in
        web development, particularly in HTML, CSS, and JavaScript. Currently
        studying Full Stack Software Development at Codespace Academy, I am
        expanding my expertise in programming languages like Python and Java, as
        well as frameworks such as React and Node.js. With a deep understanding
        of software development principles and a keen eye for detail, I thrive
        in problem-solving and strive for excellence in delivering scalable
        and efficient solutions. A collaborative mindset and effective
        communication skills enable me to contribute effectively within teams
        and create innovative software solutions. My relentless dedication to
        continuous learning and growth fuels my ambition to become a successful
        Software Engineer, making a lasting impact in the ever-evolving IT
        industry.
      </p>
      </div>
      <div className="text-lg text-gray-700 mb-6">
      ...
      <ul>
        <li>
          ...
          : A collection of small coding projects I completed during my time
          at CodeLab Academy.
        </li>
        <li>
      ...
      <div className="text-lg text-gray-700 mb-6">
        ...
        <ul className="list-disc list-inside">
          ...
          <li>
            ...
            <a
              href="https://twitter.com/youngstoningV"
              className="text-blue-500 hover:underline"
            >
              Mpho's Twitter
            </a>
